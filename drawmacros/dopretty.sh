...
root -b -q -l 'draw_spec_fake_calotime.C("yz",11,15)'	
root -b -q -l 'draw_spec_fake_calotime.C("yz",16,20)'	
root -b -q -l 'draw_spec_fake_calotime.C("yz",21,30)'	
root -b -q -l 'draw_spec_fake_calotime.C("yz",31,40)'
